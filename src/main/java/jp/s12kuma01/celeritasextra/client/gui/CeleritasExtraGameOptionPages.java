...
public class CeleritasExtraGameOptionPages {
    ...
    public static OptionPage render() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, celeritasExtraOpts)
                        .setName(TextComponent.literal(I18n.format("celeritasextra.option.render.cloud_distance")))
                        .setTooltip(TextComponent.literal(I18n.format("celeritasextra.option.render.cloud_distance.tooltip")))
                        .setControl(option -> new SliderControl(option, 100, 300, 10, ControlValueFormatter.percentage()))
                        .setBinding((opts, value) -> opts.renderSettings.cloudDistance = value,
